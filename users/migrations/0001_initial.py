    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nickname', models.CharField(blank=True, max_length=150, null=True, verbose_name='ニックネーム')),
                ('email', models.EmailField(max_length=254, unique=True, verbose_name='メールアドレス')),
                ('sex', models.CharField(choices=[('1', '男性'), ('2', '女性')], max_length=4, verbose_name='性別')),
                ...
                ('postal_code', models.CharField(max_length=7, verbose_name='郵便番号（ハイフンなし）')),
                ('prefecture', models.CharField(max_length=5, verbose_name='都道府県')),
                ('address', models.CharField(max_length=100, verbose_name='市区町村番地')),
                ('building', models.CharField(max_length=30, verbose_name='建物名')),
